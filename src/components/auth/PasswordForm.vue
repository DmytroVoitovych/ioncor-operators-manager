<template>
  <el-form style="max-width: 600px" :model="form" label-width="auto" @keyup.enter="reqAccess(form.pass,form.shift)" >
    ...
    <el-form-item>
      <el-button type="primary"  @click="reqAccess(form.pass,form.shift)" :disabled="loading || !!!form.pass.trim()" >
        Login
      </el-button>
